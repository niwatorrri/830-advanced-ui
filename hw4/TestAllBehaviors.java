...
public class TestAllBehaviors extends InteractiveWindowGroup {
	...
	public TestAllBehaviors() {
		 ...
		 * objsGroup with event LEFT_MOUSEDOWN Create a NewBehavior that creates
		 * SelectableFillRect in objsGroup with startEvent SHIFT_LEFT_MOUSEDOWN Create a
		 * NewBehavior that creates SelectableLines in objsGroup with startEvent
		 * CONTROL_LEFT_MOUSEDOWN Create a MoveBehavior that moves an object in
		 * objsGroup with startEvent CONTROL_SHIFT_LEFT_MOUSEDOWN
		 */
