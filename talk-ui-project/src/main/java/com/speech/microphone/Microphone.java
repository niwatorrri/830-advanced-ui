...
public class Microphone implements Closeable {
    ...
    private File audioFile = new File(audioFilePath);
    ...
    private void initTargetDataLine() {
        try {
            setTargetDataLine(AudioSystem.getTargetDataLine(getAudioFormat()));
     ...
     * @throws LineUnavailableException
     */
    public void captureAudioToFile(String audioFilePath) throws LineUnavailableException {
        setState(CaptureState.STARTING_CAPTURE);
