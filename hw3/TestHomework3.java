...
public class TestHomework4 extends TestFrame {
	 ...
	 * something like the following:
	  Constraint<Integer> xc = new Constraint<Integer> ( **New constraint = blueRect's right side ** );
      redRect.setX ( xc );
	  Constraint<Integer> yc = new Constraint<Integer> ( **New constraint = blueRect's Y ** );
	  redRect.setY ( yc );
	*/
	redraw (windowgroup);
